...
//    {
//        private readonly ConcurrentDictionary<string, CachedModelInfo> _modelCache = new ConcurrentDictionary<string, CachedModelInfo>();
//        private readonly ModelInstanceManager _instanceManager = new ModelInstanceManager();
//        private readonly EventDispatcher _eventDispatcher = new EventDispatcher();
//        private GameObject _templateContainer;
//        public int MaxTemplateCacheSize { get; }
//        public long MaxTemplateFileSizeInMB { get; }
//        public int CachedTemplateCount => _modelCache.Count;
//        private const string LOG_DOMAIN = nameof(ModelCache);
...
//            if (maxFileSizeInMB <= 0)
//                throw new ArgumentException("Max file size must be > 0", nameof(maxFileSizeInMB));
//            MaxTemplateCacheSize = maxCacheCount;
//            MaxTemplateFileSizeInMB = maxFileSizeInMB;
//        }
...
//            if (string.IsNullOrEmpty(modelPath) || templateObject == null)
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Invalid parameters", CachedTemplateCount, GetTotalCacheSize()));
//                return false;
//            }

//            if (_modelCache.ContainsKey(modelPath))
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateDuplicateEvent(modelPath, CachedTemplateCount, GetTotalCacheSize()));
//                return false;
//            }

//            if (CachedTemplateCount >= MaxTemplateCacheSize)
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateLimitEvent(modelPath, CachedTemplateCount, MaxTemplateCacheSize, GetTotalCacheSize()));
//                return false;
//            }

//            if (templateSizeInMB > MaxTemplateFileSizeInMB)
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateSizeLimitEvent(modelPath, templateSizeInMB, MaxTemplateFileSizeInMB, GetTotalCacheSize()));
//                return false;
//            }
...
//            if (gltfComponent == null)
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Template missing InstantiatedGLTFObject", CachedTemplateCount, GetTotalCacheSize()));
//                return false;
//            }
...
//            if (_modelCache.TryAdd(modelPath, templateInfo))
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateAddedEvent(modelPath, templateObject, templateSizeInMB, CachedTemplateCount, GetTotalCacheSize()));
//                return true;
//            }

//            NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Failed to add to cache", CachedTemplateCount, GetTotalCacheSize()));
//            return false;
//        }
...
//            if (string.IsNullOrEmpty(modelPath))
//            {
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Invalid path", CachedTemplateCount, GetTotalCacheSize()));
//                return false;
//            }
...
//                NotifyStateChanged(ModelCacheEventArgs.CreateRemovedEvent(modelPath, templateInfo.ModelObject, CachedTemplateCount, GetTotalCacheSize()));
//                return true;
//            }

//            NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Model not found in cache", CachedTemplateCount, GetTotalCacheSize()));
//            return false;
//        }
...
//        {
//            ThrowIfDisposed();
//            var previousCount = CachedTemplateCount;
//            var previousSize = GetTotalCacheSize();
...
//            NotifyStateChanged(ModelCacheEventArgs.CreateClearedEvent(previousCount, previousSize));
//        }
...
//            {
//                Debug.LogError($"[{LOG_DOMAIN}] Invalid model path for CreateInstance");
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Invalid path for instance creation", CachedTemplateCount, GetTotalCacheSize()));
//                return null;
//            }
...
//            {
//                Debug.LogError($"[{LOG_DOMAIN}] Template not found for path: {modelPath}");
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Template not found", CachedTemplateCount, GetTotalCacheSize()));
//                return null;
//            }
...
//            {
//                Debug.LogError($"[{LOG_DOMAIN}] Template missing InstantiatedGLTFObject: {modelPath}");
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Invalid template format", CachedTemplateCount, GetTotalCacheSize()));
//                return null;
//            }
...
//            {
//                Debug.LogError($"[{LOG_DOMAIN}] Failed to duplicate GLTF object: {modelPath}");
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(modelPath, "Failed to create instance", CachedTemplateCount, GetTotalCacheSize()));
//                return null;
//            }
...
//            if (!IsDisposed)
//            {
//                // Additional processing logic can be added
//                Debug.Log($"[{LOG_DOMAIN}] Cache state change: {args}");
//                _eventDispatcher.NotifyStateChanged(args);
//            }
//        }
...
//            {
//                Debug.LogError($"[{LOG_DOMAIN}] Error destroying GameObject: {ex.Message}");
//                NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(null, $"Error destroying object: {ex.Message}", CachedTemplateCount, GetTotalCacheSize()));
//            }
//        }
...
//                {
//                    Debug.LogError($"[{LOG_DOMAIN}] Error during Clear in Dispose: {ex.Message}");
//                    NotifyStateChanged(ModelCacheEventArgs.CreateErrorEvent(null, $"Error during dispose: {ex.Message}", CachedTemplateCount, GetTotalCacheSize()));
//                }
//                _instanceManager.Dispose();
//                _eventDispatcher.Dispose();
//            }
